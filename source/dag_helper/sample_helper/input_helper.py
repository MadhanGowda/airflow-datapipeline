...
def split_csv_data(*args, **kwargs):
    ...
    ti = kwargs['ti']
    csv_data = ti.xcom_pull(task_ids='read_csvdata', key='unloaded_data')
...
def split_csv_data_by_date(*args, **kwargs):
